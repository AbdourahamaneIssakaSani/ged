...
Revision ID: 1ad85fe4b459
Revises: 403c7d5f252d
Create Date: 2021-06-14 02:57:59.722542
...
revision = '1ad85fe4b459'
down_revision = '403c7d5f252d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('file', sa.Column('is_deleted', sa.Integer(), nullable=True))
    op.add_column('file', sa.Column('delete_date', sa.DateTime(), nullable=True))
    op.add_column('file', sa.Column('is_shared', sa.Integer(), nullable=True))
    ...
    op.add_column('folder', sa.Column('is_deleted', sa.Integer(), nullable=True))
    op.add_column('folder', sa.Column('delete_date', sa.DateTime(), nullable=True))
    op.add_column('folder', sa.Column('is_shared', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('folder', 'is_shared')
    op.drop_column('folder', 'delete_date')
    op.drop_column('folder', 'is_deleted')
    ...
    op.drop_column('file', 'delete_date')
